export const PRESTIGE_RADAR_QUERIES = [
  { channel: "instagram", label: "Inicio running", query: "empezar a correr consejos argentina" },
  { channel: "instagram", label: "Ropa running", query: "ropa para running consejos argentina" },
  { channel: "instagram", label: "Ampollas y roce", query: "correr ampollas roce pies running" },
  ...
  { channel: "facebook", label: "Consultas runners", query: "consejos para empezar running argentina" },
  { channel: "facebook", label: "Ropa deportiva", query: "que ropa usar para correr running" },
  { channel: "facebook", label: "Trail y comodidad", query: "trail running ampollas medias" },
