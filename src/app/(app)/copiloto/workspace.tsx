...
export function CopilotWorkspace({ activeClient, youtube, filters, opportunities }: { activeClient: { slug: string; name: string } | null; youtube: { account: string; connected: boolean; channelTitle: string } | null; filters: { brands: { id: string; name: string }[]; channels: { id: string; name: string }[]; selectedBrand: string; selectedChannel: string; selectedResponse: string; selectedSort: string }; opportunities: Opportunity[] }) {
