...
def run_midday(args: argparse.Namespace) -> None:
    ...
    auto_dist_args = ["auto-distribution", "--channels", "facebook,instagram,youtube,x", "--limit", "16", "--per-channel", "2"]
    if args.dry_run:
...
def main() -> None:
    ...
    watch_parser.add_argument("--distribution-limit", type=int, default=10, help="Limite para piezas de distribucion")
    ...
    watch_parser.add_argument("--per-channel", type=int, default=2, help="Limite por canal en auto-distribution")
